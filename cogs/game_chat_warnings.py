...
words = ['даун', 'долбaёб', 'долбаеб', 'нaхуй', 'даунихa', 'ебaл', 'шлюхa', 'пидор', 'пидорaс', 'негрилa', 'хуесос', 'хуесосинa', 'сучкa', 'проституткa', 'аутист', 'гандон', 'педик', 'мразь', 'тварь', 'гитлер', 'украина', 'украину', 'украины', 'россия', 'россию', 'россии', 'трахал', 'урод']
